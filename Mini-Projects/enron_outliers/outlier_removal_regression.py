...
### before outlier removal:- slope: 5.08, intercept: 25.2, r-squared score: 0.878
...
print("--- Regression info with outliers ---")
reg_info(reg)
...
if len(cleaned_data) > 0:
    ...
    try:
        ...
        print("--- Regression info with 10% highest residual error removed ---")
        reg_info(reg)
